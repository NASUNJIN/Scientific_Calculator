...
public class ScientficCalculator {
	...
	private void initialize() {
		...
		btnNewButton_2.setFont(new Font("나눔고딕 ExtraBold", Font.BOLD, 18));
		...
		btnNewButton_4.setFont(new Font("배달의민족 주아", Font.PLAIN, 18));
		...
		btnCos.setFont(new Font("나눔스퀘어 Bold", Font.PLAIN, 18));
		...
		btnTan.setFont(new Font("나눔스퀘어 ExtraBold", Font.PLAIN, 18));
